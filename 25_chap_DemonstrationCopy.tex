...
\begin{figure}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=0.45\textheight]{graphics/PhonePhotos/04 - ReaderBefore.jpg}
...
%\begin{figure}[h!]
%	\centering
%	\includegraphics[width=\textwidth]{graphics/PhonePhotos/10 - NegativeTest.jpg}
%	\caption{Negative Test}
%	\label{fig:NegativeTest}
%\end{figure}
