\chapter{Collusion Formula Examples}
...
%Eventually operator semantics: $e\ t  \Vdash \LTLeventually\varphi$ iff $e\ t \Vdash \varphi$ or $t \Vdash \LTLeventually\varphi$\\
%And operator semantics: $e\ t  \Vdash \varphi \land \psi$ iff $e\ t \Vdash \varphi$ and $e\ t \Vdash \psi$\\ 
%Literal semantics: $e\ t  \Vdash \varphi$ holds iff $e = \varphi $ when $\varphi$ is a literal\\
\begin{enumerate}
